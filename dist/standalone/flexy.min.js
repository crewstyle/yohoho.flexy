...
//create wrapper
a.$el.wrap('<div class="'+a.options.classname+'" />'),a.$wrap=a.$el.closest("."+a.options.classname),
//add CSS to wrapper
...
//add CSS to wrapper
a.$wrap.css({boxSizing:"border-box",height:0,overflow:"hidden",paddingBottom:"67.5%",paddingTop:a.toRem(25)+"rem",position:"relative"}),"OBJECT"===b)c=a.$el.attr("data");else if("EMBED"===b||"IFRAME"===b)c=a.$el.attr("src");else{if("VIDEO"!==b)return;c=a.$el.attr("src"),"undefined"!=typeof c&&c!==!1||(c=a.$el.find("source:first-child").attr("src"))}
//vimeo
c.match(/player\.vimeo\.com/)&&(a.options.widescreen=!0,a.$wrap.css("padding-top",0)),
//wide screens
